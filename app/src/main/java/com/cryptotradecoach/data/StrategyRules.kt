...
data class StrategyRules(
    ...
    companion object {
        val DEFAULT = StrategyRules(
            version = "v6-fast-alt-momentum-capture",
            minimumScore = 70.0,
            maxResults = 5,
            validForMinutes = 240,
            entryBandPct = 0.10,
            candidateSelection = CandidateSelectionRules(
                maxCandleTargets = 80,
                topTradeValueCount = 90,
                topChangeRateCount = 60,
                volumeBuildupCount = 50,
                quietAccumulationCount = 25,
                medianTradeValueMultiplier = 0.85,
                minBuildupChangeRatePct = -2.0,
                maxBuildupChangeRatePct = 12.0,
                maxQuietAbsChangeRatePct = 1.8,
            ),
            compressionBreakout = CompressionBreakoutRules(
                enabled = true,
                rangeCompressionRatio = 0.72,
                maxDistanceTo15mHighPct = 1.65,
                minVolumeAcceleration = 1.35,
                minFiveMinuteVolumeRatio = 1.25,
            ),
            ...
            trendPullback = TrendPullbackRules(
                ...
                min15mMaMultiplier = 0.999,
                minPriorLowMultiplier = 0.988,
                pullbackLookback = 10,
                reclaimLookback = 5,
            ),
            bearDecouplingBounce = BearDecouplingBounceRules(
                ...
                minFourHourVolumeMultiple = 1.55,
                maxPreviousFourHourVolumeMultiple = 4.2,
                maxPriceOver240mMa20Pct = 10.0,
                maxBearishUpperWickPct = 62.0,
                decouplingScoreCap = 28.0,
                wickPenalty = 9.0,
            ),
            prePumpRotation = PrePumpRotationRules(
                enabled = true,
                minChange24hPct = -2.5,
                maxChange24hPct = 22.0,
                maxChange30mPct = 7.0,
                maxChange5mPct = 3.8,
                maxTradeValueRank = 75,
                maxChangeRank = 65,
                minRotation30mPct = 0.30,
                minVolumeAcceleration = 1.18,
                minFiveMinuteVolumeRatio = 1.18,
                minFifteenMinuteVolumeRatio = 1.12,
                maxRangePct = 8.5,
                minRangePosition = 0.50,
                minHighProximityMultiplier = 0.982,
                minCloseStairCount = 1,
            ),
            scoring = ScoringRules(
                overheat24hBasePct = 18.0,
                overheat24hWeight = 0.75,
                overheat30mBasePct = 6.0,
                overheat30mWeight = 1.2,
                overheat5mBasePct = 3.2,
                overheat5mWeight = 2.4,
                overheatMax = 22.0,
                hardBlockBtc24hBelowPct = -8.0,
                hardBlock30mPumpPct = 8.0,
                hardBlock5mPumpPct = 4.5,
                hardBlockRedUpperWickPct = 62.0,
            ),
            risk = RiskRules(
